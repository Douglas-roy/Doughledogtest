...
function placePieces(square,row,col){
    ...
    if(row==6){
        place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/wPawn.png');
        square.dataset.piece="wP";
    }else if(row==1){
        place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/bPawn.png');
        ...
        switch(col){
            case 0:
            case 7://rooks
                place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/${color}Rook.png');
                square.dataset.piece=color+"R";
                break;
            case 1:
            case 6://knights
                place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/${color}Knight.png');
                square.dataset.piece=color+"N";
                break;
            case 2:
            case 5: //bishops
                place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/${color}Bishop.png');
                square.dataset.piece=color+"B";
                break;
            case 3: //queen
                place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/${color}Queen.png');
                square.dataset.piece=color+"Q";
                break;
            default: //king
                place(square,'https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/${color}King.png');
...
function place(square, pieceSrc) {
    ...
    piece.style.backgroundImage = `url(https://raw.githack.com/Douglas-roy/Doughledogtest/v1.7.0/pieces/${pieceSrc})`;
